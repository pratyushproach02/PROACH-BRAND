...
export const products = [
  ...
  },
  {
    ...
    voltage: '3.3 kV, 6.6 kV, 11 kV, 22 kV, 33 kV (E/UE)',
    capacity: '3 Core x 35 sq.mm to 3 Core x 630 sq.mm',
    cooling: 'Direct Burial / Cable Trench',
    standards: 'IS 7098 (Part 2), IEC 60502-2',
    specs: [
      { label: 'Conductor', value: 'Class 2 Stranded Electrolytic Grade Aluminum / Copper' },
      { label: 'Insulation', value: 'Triple Extruded Cross-Linked Polyethylene (XLPE)' },
      { label: 'Screening', value: 'Extruded Semiconducting layer + Copper Tape Screen' },
      { label: 'Armoring', value: 'Galvanized Flat Steel Strip / Round Steel Wire' },
      { label: 'Outer Sheath', value: 'Heavy Duty Extruded FRLS / Zero Halogen PVC' }
    ],
    features: [
      ...
      'Tested to withstand high dielectric stress and emergency overloads'
    ]
  },
  {
    id: 'cb-02',
