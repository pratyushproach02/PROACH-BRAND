...
export const products = [
  ...
  },
  {
    id: 'cb-01',
    category: 'cables',
    name: 'Gloster 11kV (E) / 22kV (UE) / 33kV XLPE Armored HT Power Cables',
    model: 'GLOSTER-XLPE-11/22/33KV',
    tag: 'High Voltage Underground & Substation',
    badge: 'Gloster XLPE • IS 7098 Part-II',
    image: '/images/products/gloster_xlpe_cable_roll.jpg',
    detailImage: '/images/products/gloster_xlpe_cable_detail.jpg',
    description: 'Genuine Gloster heavy-duty Cross-Linked Polyethylene (XLPE) insulated, steel strip/wire armored electric power cable manufactured and certified strictly under IS 7098 (Part - II). Engineered for direct underground burial, substation feeders, and high-altitude mountain grid distribution.',
    voltage: '11 kV (E) / 22 kV (UE) / 33 kV (E)',
    capacity: '150, 185, 240, 300, 400, 630 SQ MM',
    cooling: 'Direct Burial / Underground Trench',
    standards: 'IS 7098 (Part - II), ISI Marked, IEC 60502-2',
    specs: [
      { label: 'Manufacturer / Brand', value: 'Gloster Cables Limited (Genuine Embossed Marking)' },
      { label: 'Standard Specification', value: 'IS 7098 (Part - II) with Official ISI Mark' },
      { label: 'Voltage Grade (Rating)', value: '11 kV (E) / 22 kV (UE) / 33 kV (E)' },
      { label: 'Cross Sectional Area', value: '150 / 185 / 240 / 300 / 400 / 630 SQ MM' },
      ...
      { label: 'Screening Layer', value: 'Extruded Semi-Conducting Compound + Non-Magnetic Bare Copper Tape' },
      { label: 'Armoring Type', value: 'Galvanized Flat Steel Strip / Round Steel Wire (GSFA / GSWA)' },
      { label: 'Outer Sheath', value: 'Heavy-Duty Extruded Blue FRLS (Moisture & Soil Chemical Resistant)' },
      { label: 'Operating Temperature', value: '90°C Normal Operation / 250°C Short-Circuit Rating' },
      { label: 'Installation Suitability', value: 'Direct Burial Underground, Cable Trenches & Mountain Conduit' }
    ],
    features: [
      'Certified under IS 7098 Part-II with embossed Gloster XLPE markings for 100% genuine quality assurance',
      'Engineered for 11kV (E) / 22kV (UE) power transmission with superior thermal withstand capacity up to 250°C',
